...
const RecruitCard = ({ item, onClick }: RecruitCardProps) => {
  return (
    <div
      onClick={onClick}
      className="flex h-[330px] w-[402px] cursor-pointer flex-col justify-between rounded-[30px] border border-gray-200 bg-white p-[24px] transition-shadow hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)]"
    >
