...
const JobInfo = () => {
  return (
    <div className="mt-10 flex w-full flex-row gap-4 px-[120px]">
      <div className="flex w-full max-w-[690px] flex-col items-start">
        ...
        <div className="flex flex-col gap-[50px]">
          <div className="flex flex-col items-start justify-center gap-5">
            <div className="mt-[50px] text-gray-900 font-T03-B">직업 소개</div>
            <div className="h-[80px] text-gray-900 font-B01-M">
              요양보호사는 노인이나 장애인 등 일상생활이 어려운 분들을 지원하는
              직업입니다. 요양보호사는 노인이나 장애인 등 일상생활이 어려운
              분들을 지원하는 직업입니다. 요양보호사는 노인이나 장애인 등
              일상생활이 어려운 분들을 지원하는 직업입니다.
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div>
              <div className="mt-5 flex flex-row items-center gap-1">
                <span className="text-gray-900 font-T05-SB">대인관계 빈도</span>
                <Info />
              </div>
              <div className="mt-[6px] text-gray-900 font-B01-M">높음</div>
            </div>
